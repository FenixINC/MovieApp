...
//        @JvmStatic
//        fun deserializer() {
//            var deser: JsonDeserializer<Movie> = JsonDeserializer { json, typeOfT, context ->
//                val jsonObject = json.asJsonObject
//
//                if (jsonObject.get("modelName") == null) {
//                    Timber.e("Unknown model or type when parsing WidgetContent")
...
//            gsonBuilder.registerTypeAdapter(Movie::class.java, Movie.deserializer())
